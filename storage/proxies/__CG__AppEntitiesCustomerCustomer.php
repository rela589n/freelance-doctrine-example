...
namespace DoctrineProxies\__CG__\App\Entities\Customer;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Customer extends \App\Entities\Customer\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'uuid', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'rememberToken', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'email', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'password', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'postedJobs', '' . "\0" . 'App\\Entities\\Customer\\Customer' . "\0" . 'recordedEvents'];
        }
     ...
     * {@inheritDoc}
     */
    public function publishJob(\App\ValueObjects\JobTitle $title, \App\ValueObjects\JobDescription $description): \App\Entities\Job\Job
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'publishJob', [$title, $description]);

        return parent::publishJob($title, $description);
    }

    /**
     * {@inheritDoc}
     */
    public function addPublishedJob(\App\Entities\Job\Job $job): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPublishedJob', [$job]);

        parent::addPublishedJob($job);
    }
     ...
     * {@inheritDoc}
     */
    public function getPostedJobs(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPostedJobs', []);

        return parent::getPostedJobs();
    }
